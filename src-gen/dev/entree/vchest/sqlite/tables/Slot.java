...
public class Slot extends TableImpl<SlotRecord> {
    ...
    public UniqueKey<SlotRecord> getPrimaryKey() {
        return Keys.SLOT__PK_SLOT;
    }

    @Override
    public List<ForeignKey<SlotRecord, ?>> getReferences() {
        return Arrays.asList(Keys.SLOT__FK_SLOT_PK_CHEST);
    }

    private transient ChestPath _chest;

    /**
     * Get the implicit join path to the <code>chest</code> table.
     */
    public ChestPath chest() {
        if (_chest == null)
            _chest = new ChestPath(this, Keys.SLOT__FK_SLOT_PK_CHEST, null);
